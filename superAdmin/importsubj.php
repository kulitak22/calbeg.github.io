  ...
  <section class="home-section">
        <div class="modal-content">
            <div class="container">
              ...
              <form method="POST" action="../superAdmin/import/importSS.php" name="uploadcsv" enctype="multipart/form-data"> 
              <p>Please select valid CSV file to Import</p>
              <p>The CSV file must contain the following format</p>
              <img src="../assets/img/fsubj.png" style="width: 100%; ">
              <br>
              <p><input type="file" name="file" accept=".csv" ></p>
              <button type="button" onclick="location.href='viewSubject.php';" class="cancelbtn">Cancel</button>
