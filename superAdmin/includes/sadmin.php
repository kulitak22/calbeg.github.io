...
<div class="container">
        <div>
          <div class="grid-container">
            ...
            <!-- ===== ADD ===== -->
            <div onclick="location.href='../superAdmin/addadmin.php';" style="cursor: pointer;">
               <!-- div left -->
              <div class="viewleft">
              ...
              <!-- div right -->
              <div class="viewright">
              <span class="material-symbols-outlined" id="dashLogo">add_circle</span>              </div>
            </div>
            <!-- ===== IMPORT ===== -->
        ...
        <div id="id02" class="modal">  
          <div class="modal-content">
            <div class="container">
              ...
              <form method="POST" action="../superAdmin/import/importA.php" name="uploadcsv" enctype="multipart/form-data"> 
